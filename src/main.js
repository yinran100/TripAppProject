...
/**
  ...
  stylus版本0.52.4  stylus-loader版本2.5.0，npm install stylus@0.52.4 -g --save,npm install stylus-loader@2.5.0 -g --save  否则vue 报错：Module build failed: Error: Cannot find module 'when' 
  ...
  滚动插件better-scroll，npm install better-scroll --save
